<div class="page-section">
    <div class="container">
      ...
      <form class="main-form" action="{{url('/appointment')}}" method="POST">
        ...
        <div class="row mt-5 ">
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
            <select name="doctor" id="departement" class="custom-select" required="">
              ...
              <option value="{{$doctors->speciality}}">{{$doctors->name}} -- {{$doctors->speciality}}</option>
              @endforeach
            </select>
          </div>
        ...
        <button onclick="return alert('Appointment has been placed')" type="submit" class="btn btn-primary mt-3 wow zoomIn">Submit Request</button>
      </form>
    </div>
  </div> 